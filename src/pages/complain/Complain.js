...
import { Box, Card, HStack, useToast, Text } from "@chakra-ui/react";
import { FcGraduationCap } from "react-icons/fc";
import axios from "axios";
import { BsLinkedin, BsTwitter } from "react-icons/bs";
import { MdFacebook, MdOutlineEmail, MdQuestionAnswer } from "react-icons/md";
...
const Complain = () => {
  ...
  const handleRequest = () => {
    axios
      .post("http://localhost:5000/addreport", {
        title,
        body: content,
        postedBy: profile[0],
      })
          ...
          <Box>
            <VStack spacing={{ base: 4, md: 8, lg: 5 }}>
              ...
              >
                ...
                >
                  <Tooltip
                    label={hasCopied ? "facebook Copied!" : "Copy facebook"}
                    closeOnClick={false}
                    hasArrow
                  >
                    <IconButton
                ...
                >
                  <VStack spacing={5}>
                    ...
                    <FormControl isRequired>
                      <FormLabel>гомдол</FormLabel>
                      <Textarea
                        placeholder="гомдол бичих"
                        value={content}
